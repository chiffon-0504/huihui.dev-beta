...
const { right, ...missingDirection } = en.home.move;
void right;
// @ts-expect-error Every locale must provide all four window movement labels.
export const incompleteMovement: LocaleContent = { ...en, home: { ...en.home, move: missingDirection } };
