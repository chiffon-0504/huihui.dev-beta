...
const worksImages = [
  { id: "2001", width: 3024, height: 1859, lazy: false, sizes: wideImageSizes },
  { id: "2002", width: 3024, height: 3078, lazy: true, sizes: wideImageSizes },
  { id: "2003", width: 4615, height: 2660, lazy: true, sizes: narrowImageSizes },
  { id: "2004", width: 5043, height: 3538, lazy: true, sizes: narrowImageSizes },
];
const derivativeDimensions = new Map([
  ["2001", [[900, 553], [1600, 984]]],
  ["2002", [[900, 916], [1600, 1629]]],
  ["2003", [[900, 519], [1600, 922]]],
    ...
    for (const pagePath of worksPages) {
      ...
      expect(contracts).toEqual(
        worksImages.map((image) => ({
          ...
          srcset:
            `/images/${image.id}_w-900.webp 900w, ` +
            `/images/${image.id}_w-1600.webp 1600w`,
          sizes: image.sizes,
