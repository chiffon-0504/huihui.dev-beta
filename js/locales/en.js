...
window.HUIHUI_I18N.en = {
  ...
  systemStatus: {
    history: {
      ...
      observedOne: "{count} day observed",
      observedMany: "{count} days observed",
      dateRange: "Observed date range",
      noHistory: "No observed history available.",
      recentImpact: "Recent service impact",
      noImpact: "No service-impact days in the observed history.",
      downtime: "Downtime",
      maintenance: "Maintenance",
      fetched: "History fetched",
      chronological: "Observed days, oldest to newest",
      legend: "History status legend",
      lessThanSecond: "Less than 1 sec",
    },
    title: "System Status",
