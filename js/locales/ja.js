...
window.HUIHUI_I18N.ja = {
  ...
  systemStatus: {
    incidents: {
      title: "インシデントとステータス更新",
      intro: "Better Stack が公開するインシデントとステータス更新です。上記の現在の稼働状況および日別の可用性履歴とは別に表示します。",
      loading: "インシデント履歴を読み込み中…",
      loaded: "インシデント履歴を読み込みました。",
      unavailable: "現在、インシデント履歴を取得できません。",
      empty: "現在、インシデントまたはステータス更新はありません。",
      fetched: "最終取得",
      viewReport: "ステータスレポートを見る",
      chronological: "ステータス更新（古い順）",
    },
    history: {
      title: "可用性と履歴",
