...
Keep the tone conversational: plain verbs, no filler, with tone matched to the brand and the audience. Use English sentence case for headings, buttons, and other UI copy, preserving proper nouns, brands, acronyms, and identifiers. zh-Hant and Japanese copy follow their own language conventions; do not apply English casing rules to them. Let each written element do exactly one job.
