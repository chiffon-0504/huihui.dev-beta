...
selection for built Home/About entries, complete content, and links preserving
the current page and fragment. About HTML metadata and the no-JavaScript fallback
